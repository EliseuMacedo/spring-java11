package com.tecinfo.course.config;
...
import com.tecinfo.course.entities.Payment;
...
import com.tecinfo.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired // Intanciação automática por injeção de dependência
	...
	@Override // esse método vai rodar quando a aplicação for iniciada
	public void run(String... args) throws Exception {
		...
		// Formato Iso 8601 Z = UTC = Timezone GMT

		categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));

		p1.getCategories().add(cat2);// Associação de objetos adicionado categoria 2 ao produto 1
